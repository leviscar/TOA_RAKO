//////////////////////////////////////////////
//  * 硬件连接 ----------------------------
//  *         | PC3-CE          :24L01-CE |PA3-CE
//  *         | PC9-IRQ  :      24L01-IRQ |PB11-IRQ
//  *         | PC8-CS  :        24L01-CS  |PA4-CS
//  *         | PB13-SPI2-SCK  : 24L01-CLK |PA5-SPI1-CLK
//  *         | PB14-SPI2-MISO : 24L01-DO  |PA6-SPI11-MISO
//  *         | PB15-SPI2-MOSI : 24L01-DIO |PA7-SPI1-MOSI
//  *          ----------------------------
//  * 库版本  ：ST3.0.0
//  *
////////////////////////////////////////////
...
const uint8_t RX_ADDRESS[RX_ADR_WIDTH]={0x68,0x86,0x66,0x88,0x28}; //接收地址
...
//		NRF24L01_Write_Reg(WRITE_REG+EN_AA,0x00);    //close通道0自动应答    
  	...
  	NRF24L01_Write_Reg(WRITE_REG+CONFIG, 0x0f);//配置基本工作模式的参数;PWR_UP,EN_CRC,16BIT_CRC,接收模式
		...
		NRF24L01_Write_Reg(WRITE_REG+STATUS,state); //清除中断标志
...
//  	NRF24L01_Write_Reg(WRITE_REG+EN_AA,0x00);//close
		//NRF24L01_Write_Reg(WRITE_REG+EN_RXADDR,0x01); //使能通道0的接收地址  
  	NRF24L01_Write_Reg(WRITE_REG+EN_RXADDR,0x01);
		NRF24L01_Write_Reg(WRITE_REG+SETUP_RETR,0x01);//设置自动重发间隔时间:250us + 86us;最大自动重发次数:1次
...
uint8_t NRF24L01_RxPacket(uint8_t *rxbuf)
{
	...
	uint8_t fifo_state;
	state=NRF24L01_Read_Reg(STATUS);  //读取状态寄存器的值    	 
	fifo_state=NRF24L01_Read_Reg(FIFO_STATUS);//读取FIFO_STATUS状态寄存器的值
